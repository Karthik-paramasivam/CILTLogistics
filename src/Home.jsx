      ...
      <div className="container-fluid m-0 p-0 ">
                  ...
                  >
                    ...
                    >
                      <Select placeholder="Select your course">
                        ...
                        <Option value="CILT Level 2">CILT Level 2</Option>
                        <Option value="CILT Level 3">CILT Level 3</Option>
                        {/* <Option value="cilt_level_4">CILT Level 4</Option> */}
                        <Option value="CILT Level 5">CILT Level 5</Option>
                        <Option value="CILT Level 6">CILT Level 6</Option>
                      </Select>
                    </Form.Item>
                    <Form.Item>
                  ...
                  <div className="course-text ">
                    ...
                    >
                      ...
                      >
                        ...
                        (CILT, UK) stands as the global leader in advocating for
                        supply chain, logistics, and transport and setting
                        global standards. CILT is dedicated to crafting
                        effective programmes and setting ambitious objectives
                        for supply chain logistics, and transport that form the
                      ...
                      >
                        ...
                        fostering the exchange of best practices and
                        knowledge-sharing. Moreover, it actively promotes
                        participation and professional advancement across all
                        tiers of its membership.
                      </motion.li>
                    </motion.ul>
                  </div>
                </motion.div>
              ...
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                <li className="ms-lg-4 d-flex align-items-start mt-1">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#011689" }}
                  />
                  The CILT Level 2 Introductory Certificate course is the ideal
                  choice for anyone looking to start their career in the
                  Logistics industry, catering to both frontline and supervisory
                  staff. CILT enjoys global recognition as an authority in
            ...
            <div className="col-12 col-lg-6 order-2 order-lg-2">
              ...
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                <li className="ms-lg-4 d-flex align-items-start mt-1">
                  ...
                  Transport at WingsWay Training Institute is an advanced
                  entry-level program ideal for logistic professionals seeking
                ...
                <li className="ms-lg-4 d-flex align-items-start mt-1">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#011689" }}
                  />
                  This course covers everything from sea, air, road, and rail
                ...
                <li className="ms-lg-4 d-flex align-items-start mt-1">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#011689" }}
                  />
                  The Level 5 qualification is equivalent to two years of a
                  degree program.
                </li>
                <li className="ms-lg-4 d-flex align-items-start mt-1">
                  <FontAwesomeIcon
        ...
        <div className="container-fluid bg-light border border-light pb-5">
          ...
          >
              ...
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                ...
                <li className="d-flex align-items-start mt-1">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#0971CE" }}
                  />
                  With WingsWay, benefit from intensive exam preparation,
                  scholarships, interest-free EMI options, internships, and
            ...
            {/* Image Section */}
            <div className="col-12 col-lg-6 mt-2 mt-lg-5  order-1 order-lg-3">
              <img
                src={CILT6Image}
                alt="CILT6 Image"
            ...
            <div>
              <div className=" p-3 rounded-3 ms-md-2 mt-0 h-auto">
                ...
                <p className="text-center mt-3 Testimonialpara">
                  It was such an amazing training! The trainer, Mr. Naveen was
                  so professional, and his teaching helped me a lot to know
                  about much more things technically. I highly recommend joining
            ...
            <div>
              <div className="p-3  rounded-3  mt-0  h-auto">
                ...
                <p className="text-center mt-3 Testimonialpara">
                  ...
                  team were very responsive. Least but not last, I can't miss
                  Dr. Manish's way of teaching.
                </p>
              </div>
            </div>
            <div>
              <div className="p-3 rounded-3   mt-0 h-auto">
                <h3 className="text-center mt-3 TestimonialHeading">Sameer</h3>
                <p className="text-center mt-3 Testimonialpara">
                  I recently completed a course at WingsWay Training Institute,
            ...
            <div>
              <div className="p-3  rounded-3  mt-0 h-auto">
                ...
                <p className="text-center mt-3 Testimonialpara">
                  ...
                  opportunity to learn & explore more and Mr. Naveen sir has
                  been so helping, and he ensured that we understood well.
                </p>
              </div>
            </div>
            <div>
              <div className="p-3  rounded-3  mt-0 h-auto">
                ...
                <p className="text-center mt-3 Testimonialpara">
                  ...
                  teaching methods are excellent. I recommend WingsWay Training
                  Institute for procurement professional courses. Thank you.
                </p>
              </div>
            </div>
          </Slider>
